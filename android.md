...
- [?] **Badge de l'onglet Contacts** : le point sans texte est documenté **Android uniquement** — c'est iOS qui impose d'afficher un nombre. Vérifier le rendu Android (peut-être préférable d'y afficher le point).
