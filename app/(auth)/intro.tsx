...
export default function IntroScreen() {
  ...
  return (
    ...
    >
      ...
      >
        <MotiText
          className=" font-black text-nexa italic" style={{ fontSize: 60 }}
          from={{ opacity: 0, translateY: 30 }}
          animate={{ opacity: 1, translateY: 0 }}
          transition={{
            type: "spring",
        ...
        <MotiText
          className=" font-medium italic text-nexa" style={{ fontSize: 30 }}
      ...
      >
        ...
        >
          <MotiText
            className="text-white font-semibold italic" style={{ fontSize: 24 }}
            from={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        >
          <MotiText
            className="text-nexa italic font-semibold " style={{ fontSize: 24 }}
            from={{ opacity: 0 }}
            animate={{ opacity: 1 }}
