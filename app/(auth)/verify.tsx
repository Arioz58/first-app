    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      ...
      >
        ...
        >
          ...
          >
            <Text className=" font-black text-nexa italic" style={{ fontSize: 48 }}>
              {t("auth.verification")}
            </Text>
            <Text className=" font-medium italic text-nexa mb-6" style={{ fontSize: 24 }}>
          ...
          {error ? (
            <MotiView
              ...
              className="mb-4"
            >
              <Text className="text-red-500 text-center font-medium " style={{ fontSize: 16 }}>
                {error}
              </Text>
            </MotiView>
          ) : null}
          ...
          >
            ...
            <View className="mt-2">
              {resending ? (
                ...
                <Text className="text-gray-400 " style={{ fontSize: 16 }}>
                  {t("auth.resend_in", { time: formatTime(resendIn) })}
                </Text>
              ) : (
                <TouchableOpacity onPress={handleResend}>
                  <Text className="text-nexa font-semibold " style={{ fontSize: 16 }}>
                    {t("auth.resend_code")}
                  </Text>
                </TouchableOpacity>
              )}
