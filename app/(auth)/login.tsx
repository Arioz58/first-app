    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      ...
      >
        ...
        >
          ...
          >
            <Text className=" font-black text-nexa italic" style={{ fontSize: 36, lineHeight: 40 }}>
              {isNewUser ? t("auth.create_account") : t("auth.connection")}
            </Text>
            <Text className=" font-medium italic text-nexa mb-4" style={{ fontSize: 24, lineHeight: 32 }}>
          ...
          {isNewUser && (
            <View className="mb-4 mt-4">
              ...
              />
              {nameError ? (
                <Text className="text-red-500 mt-1 ml-1" style={{ fontSize: 14, lineHeight: 20 }}>
                  {nameError}
                </Text>
              ) : null}
            </View>
          ...
          {serverError ? (
            <Text className="text-red-500 text-center mb-3" style={{ fontSize: 14, lineHeight: 20 }}>
              {serverError}
            </Text>
          ) : null}
          ...
          {isNewUser && (
            ...
            >
              ...
              />
              <Text className="ml-2 flex-1 text-gray-600 leading-6" style={{ fontSize: 16, lineHeight: 24 }}>
                {(() => {
